    ...
    <div className="pt-24 pb-20 bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="flex items-center mb-12 justify-center">
            <div className="h-0.5 w-10 bg-scoop-300 mr-6"></div>
            <h2 className="heading-3 text-gray-900 text-center font-bold">Management Team</h2>
            <div className="h-0.5 w-10 bg-scoop-300 ml-6"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 max-w-3xl mx-auto">
            <TeamMember
